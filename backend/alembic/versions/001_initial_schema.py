...
def upgrade() -> None:
    ...
    op.execute("CREATE TYPE migrationrecommendation AS ENUM ('rehost', 'replatform', 'repurchase', 'refactor', 'retire', 'retain')")
    ...
    op.create_table('users',
        ...
        sa.Column('role', postgresql.ENUM('admin', 'collaborator', 'viewer', name='userrole'), nullable=False),
    ...
    op.create_table('application_assessments',
        sa.Column('id', postgresql.UUID(as_uuid=True), nullable=False),
        sa.Column('project_id', postgresql.UUID(as_uuid=True), nullable=False),
        ...
        sa.Column('expected_performance_improvement_percent', sa.Float(), nullable=True),
        sa.Column('expected_roi_months', sa.Integer(), nullable=True),
        sa.Column('recommendation', postgresql.ENUM('rehost', 'replatform', 'repurchase', 'refactor', 'retire', 'retain', name='migrationrecommendation'), nullable=True),
    ...
    op.create_index(op.f('ix_application_assessments_application_name'), 'application_assessments', ['application_name'], unique=False)
...
def downgrade() -> None:
    ...
    op.drop_index(op.f('ix_application_assessments_application_name'), table_name='application_assessments')
