...
class TestAuthEndpoints:
    ...
    @pytest.mark.asyncio
    async def test_login_valid_credentials(self, async_client: AsyncClient, test_db: AsyncSession):
    ...
    async def test_login_invalid_password(self, async_client: AsyncClient, test_user: User):
        ...
        TestHelpers.assert_error_response(response, 401, "Incorrect username or password")
    ...
    async def test_get_current_user_expired_token(self, async_client: AsyncClient, test_user: User):
        ...
        TestHelpers.assert_error_response(response, 401, "Could not validate credentials")
    
    @pytest.mark.asyncio
    async def test_update_user_profile(self, authenticated_client: AsyncClient, test_user: User):
